...
<h3>Name: DHARANI DHARAN K </h3>
<h3>Register Number: 212223040036 </h3>
<H3>Aim:</H3>
...
# 1. This is the correct DFS function using RECURSION
def dfs(graph, node, visited, path):
    if visited[node] == False:
        path.append(node)
        visited[node] = True
        
        # Go as deep as possible into each neighbor
